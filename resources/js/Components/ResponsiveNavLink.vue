...
const classes = computed(() =>
    props.active
        ? "block w-full pl-3 pr-4 py-2 border-l-4 border-primary text-left text-base font-medium text-primary bg-primary focus:outline-none focus:text-primary focus:bg-primary focus:border-primary transition duration-150 ease-in-out"
